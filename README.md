...
* **Modified [Miri's Unbound Start Menu](https://github.com/miriamlefae/pokeemerald-expansion/tree/feat/usm/1.16.1):** I had been eying up a few different graphical Start Menus, and the Unbound style one really appealed to me. I made a few changes to how Miri had this set up, including a custom UI tileset, the menu wraps around, there are split icons for Brendan's backpack/May's bag, and the player's name appears instead of Trainer Card. Really happy with this implementation and it seems stable, but may need more testing!  
